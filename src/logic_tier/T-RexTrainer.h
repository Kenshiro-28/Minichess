...
#define NEURAL_NETWORK_NUMBER_OF_HIDDEN_LAYERS 1000
...
#define MAX_CONSECUTIVE_VICTORIES (pow(NEURAL_NETWORK_NUMBER_OF_INPUTS, 2) * (NEURAL_NETWORK_NUMBER_OF_INPUTS * NEURAL_NETWORK_NUMBER_OF_HIDDEN_LAYERS + NEURAL_NETWORK_NUMBER_OF_OUTPUTS))
